...
document.head.appendChild(iframe);
  ...
  <body>
  <div id="divApplab" class="appModern running" tabindex="1" style="width: 320px; height: 450px; display: block;">${html.match(/<div class="screen".*/g)[0]
    }
  </body>
  </html>`
  ...
  buttons.forEach(button => {
    if (button.getAttribute("data-image-type") === "icon") {
      button.style["background-image"] = `url('${renderIconToString(button.getAttribute("data-canonical-image-url"), button)}')`
    }
  })
