...
function markdownTextbox(sel,nobr) {
  ...
  markbox.insertAdjacentHTML("afterend", `
    ...
    <button type="button" title="Insert Image" onclick="replaceSelectedText(document.querySelector('${sel}'),async()=>{var url = await getFileUpload(thumb.src); return '![height=100]('+url+')';})">
