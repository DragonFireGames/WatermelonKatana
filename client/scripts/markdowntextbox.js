...
function markdownTextbox(sel) {
  var markbox = document.querySelector(sel);
  markbox.outerHTML += `<button type="button" onclick="replaceSelectedText(document.querySelector('${sel}'),t=>'**'+t+'**')">
    ...
    <button type="button" onclick="replaceSelectedText(document.querySelector('${sel}'),t=>'*'+t+'*')">
      <svg fill="none" viewBox="0 0 24 24" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
    ...
    <button type="button" onclick="replaceSelectedText(document.querySelector('${sel}'),t=>'__'+t+'__')">
      <svg fill="none" viewBox="0 0 24 24" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
    ...
    <button type="button" onclick="replaceSelectedText(document.querySelector('${sel}'),async()=>{var url = await getFileUpload(thumb.src); return '![height=100]('+url+')';})">
    ...
    <button type="button" onclick="replaceSelectedText(document.querySelector('${sel}'),t=>'['+t+'](https://)')">
      <svg fill="none" viewBox="0 0 24 24" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
