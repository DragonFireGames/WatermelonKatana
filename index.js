...
app.get('/register', (req, res) =>
    res.sendFile(cldir + '/users/auth/register.html')
) // Registration page
...
app.get('/admin', adminAuth, (req, res) =>
    res.sendFile(cldir + '/users/admin.html')
)
// Basic user page, users only
app.get('/userlist', userAuth, (req, res) =>
    res.sendFile(cldir + '/users/list.html')
)
...
app.get('/project/:id', checkAuth, async (req, res) => {
    ...
    proj.views++
    sendFileReplace(res, './Pages/projects/project.html', (s) =>
        s
            .replace(
                '<!--og:meta-->',
...
app.get('/forum/post', userAuth, (req, res) =>
    res.sendFile(cldir + '/forum/publish.html')
) // Publish page, users only
...
app.get('/forum/discussion/:id', checkAuth, async (req, res) => {
    ...
    post.views++
    sendFileReplace(res, './Pages/forum/discussion.html', (s) =>
        s
            .replace(
                '<!--og:meta-->',
...
app.get('/user/:name', async (req, res) => {
    ...
    sendFileReplace(res, './Pages/users/user.html', (s) =>
        s
            .replace(
                '<!--og:meta-->',
...
app.get('/profile', userAuth, (req, res) =>
    res.sendFile(cldir + '/users/profile/profile.html')
)
app.get('/profile/edit', userAuth, (req, res) =>
    res.sendFile(cldir + '/users/profile/edit.html')
)
app.get('/profile/chpass', userAuth, (req, res) =>
    res.sendFile(cldir + '/users/profile/chpass.html')
)
app.get('/profile/verify', userAuth, (req, res) =>
    res.sendFile(cldir + '/users/profile/verification.html')
)
app.get('/verified', (req, res) =>
    res.sendFile(cldir + '/users/profile/verified.html')
)
// Notification
