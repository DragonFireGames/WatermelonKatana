...
canvas.registerFont('./Turbo/dependencies/fonts/fa-brands-400.ttf', {
    family: 'FontAwesome',
})
//canvas.registerFont("./fonts/fa-regular-400.ttf", {family: "FontAwesome"}) doesn't seem like this one is used??
canvas.registerFont('./Turbo/dependencies/fonts/fa-solid-900.ttf', {
    family: 'FontAwesome',
})
canvas.registerFont('./Turbo/dependencies/fonts/fa-v4compatibility.ttf', {
    family: 'FontAwesome',
})
...
async function exportProject(id) {
    return new Promise(async (resolve, reject) => {
        let json = await request.send(
            `${startPath}/v3/sources/${id}/main.json`,
            'json'
        )
...
async function getHTML(html, id, code) {
  ...
  <head>
    ...
    <link rel="stylesheet" href="${dependency}/applab.css">
